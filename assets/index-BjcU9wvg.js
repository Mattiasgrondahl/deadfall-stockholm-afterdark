...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(e,t,n){let r=new Float32Array(ao),i=new G(0,1,0);return new zi({name:`SphericalGaussianBlur`,defines:{n:ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Co(),fragmentShader:`
	...
	`}var wo=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new xi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},wd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Td=new Sa(-1,1,1,-1,0,1),Ed=new class extends or{constructor(){super(),this.setAttribute(`position`,new Jn([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Jn([0,2,0,0,2,0],2))}},Dd=class{constructor(e){this._mesh=new X(Ed,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Td)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Od=class extends wd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof zi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ii.clone(e.uniforms),this.material=new zi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Dd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},kd=class extends wd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Ad=class extends wd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},jd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Et(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Od(Cd),this.copyPass.material.blending=0,this.timer=new Aa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}kd!==void 0&&(r instanceof kd?n=!0:r instanceof Ad&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Md=class extends wd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Nd={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Pd.BlurDirectionX=new W(1,0),Pd.BlurDirectionY=new W(0,1);var Fd=e=>Math.min(1,Math.max(0,e)),Id=class{constructor(e,t,n,r={}){if(this.scene=e,this.camera=t,this.enabled=!1,this.composer=null,this.bloom=null,this.strength=Fd(Number.isFinite(r.strength)?r.strength:.25),!(n instanceof cl))return;let i=n.getSize(new W);this.composer=new jd(n);let a=new Md(e,t);this.bloom=new Pd(new W(i.x,i.y),this.strength,.5,0),this.composer.addPass(a),this.composer.addPass(this.bloom),this.enabled=!0}render(){this.enabled&&this.composer.render()}setStrength(e){this.strength=Fd(Number.isFinite(e)?e:this.strength),this.bloom&&(this.bloom.strength=this.strength)}setSize(e,t){this.enabled&&this.composer.setSize(e,t)}dispose(){this.bloom&&this.bloom.dispose(),this.composer&&this.composer.dispose(),this.bloom=null,this.composer=null,this.enabled=!1}},Ld=Object.freeze({TITLE:`title`,PLAYING:`playing`,PAUSED:`paused`,GAMEOVER:`gameover`}),Rd=class{constructor(){this.info={render:{calls:0,triangles:0},memory:{}},this.shadowMap={enabled:!1,type:0},this.toneMapping=0}render(){this.info.render.calls++}setPixelRatio(){}setSize(){}setAnimationLoop(){}dispose(){}},zd=class{constructor(e={}){this.headless=!!e.headless,this.canvas=e.canvas||null,this.state=Ld.TITLE,this.quality=`high`,this._lastTime=-1,this.renderer=this.headless?new Rd:null,this.env=this.headless?{document:null,window:null,canvasFactory:Bd}:{document,window,canvasFactory:()=>document.createElement(`canvas`)},this.inputState={forward:!1,back:!1,left:!1,right:!1,sprint:!1,turnX:0,turnY:0,fire:!1,reload:!1,pause:!1},this.input=null,this.player=null,this.weapon=null,this.city=null,this.lighting=null,this.audio=null,this.hud=null,this.screens=null,this.waveManager=null,this.collision=null,this.zombies=[],this.kills=0,this.timeInGame=0,this._fps=60,this.debug={state:()=>this.state,playerPos:()=>this.player?this.player.position.clone():null,health:()=>this.player?this.player.health:0,stamina:()=>this.player?this.player.stamina:0,ammo:()=>this.weapon?this.weapon.ammo:0,reserve:()=>this.weapon?this.weapon.reserve:0,wave:()=>this.waveManager?this.waveManager.wave:0,zombiesAlive:()=>this.zombies.filter(e=>!e.isDead).length,zombiesRemaining:()=>this.waveManager?this.waveManager.remaining:0,kills:()=>this.kills,setPlayerPos:(e,t)=>{this.player&&this.player.position.set(e,1.7,t)},setPlayerHealth:e=>{this.player&&(this.player.health=Math.max(0,Math.min(this.player.maxHealth,e)))},damagePlayer:e=>{this.player&&this.player.damage(e,`debug`)},shootOnce:()=>{if(this.weapon)return this.weapon.shoot()},reloadWeapon:()=>{if(this.weapon)return this.weapon.reload()},setInput:e=>Object.assign(this.inputState,e),spawnZombie:(e,t,n)=>this.spawnZombie(e,t,n),killAllZombies:()=>{for(let e of this.zombies)e.isDead||e.damage(e.health+10)},forceWaveClear:()=>{this.waveManager&&this.waveManager.forceClear(this)},resetRun:()=>{if(this.state===Ld.PLAYING||this.state===Ld.PAUSED){for(let e of this.zombies)e.dispose();this.zombies=[],this.setState(Ld.GAMEOVER)}this.startGame()},step:e=>this.step(e),frameStats:()=>this.rendererStats(),sceneStats:()=>this.sceneStats()}}step(e){let t=Math.min(Math.max(e,0),.1);return this.inputState.pause&&(this.inputState.pause=!1,this.togglePause()),this.timeInGame+=t,this.state===Ld.PLAYING&&this.update(t),this.render(),this.state===Ld.PLAYING&&this.hud&&this.hud.update(this.player,this.weapon,this.waveManager),t}tick(){let e=performance.now(),t=this._lastTime<0?0:Math.min((e-this._lastTime)/1e3,.1);this._lastTime=e,this.step(t),t>0&&(this._fps=this._fps*.9+1/t*.1)}start(){this.setupScene(),this.headless||(this.setupRenderer(),this.resize(),this.env.window.addEventListener(`resize`,()=>this.resize())),this.initSubsystems(),this.headless?this.render():this.renderer.setAnimationLoop(()=>this.tick())}setupRenderer(){try{this.renderer=new cl({canvas:this.canvas,antialias:!0,powerPreference:`high-performance`})}catch(e){console.warn(`WebGL antialias failed, retrying plain:`,e),this.renderer=new cl({canvas:this.canvas,antialias:!1})}this.renderer.setPixelRatio(Math.min(this.env.window.devicePixelRatio||1,2))}setupScene(){this.scene=new fn,this.scene.background=new Y(395538),this.scene.fog=new dn(725024,.022),this.camera=new _a(75,16/9,.1,400),this.camera.position.set(0,1.7,12)}resize(){if(!this.renderer||!this.env.window)return;let e=this.env.window.innerWidth,t=this.env.window.innerHeight;this.renderer.setSize(e,t),this.postfx&&this.postfx.setSize(e,t),this.camera&&(this.camera.aspect=e/t,this.camera.updateProjectionMatrix())}initSubsystems(){!this.headless&&this.env.document&&this.canvas&&(this.input=new ul(this,this.inputState),this.input.attach(),this.input.on(`unlock`,()=>this.handleUnlock()),this.input.on(`lock`,()=>{this.state===Ld.PAUSED&&this.setState(Ld.PLAYING)})),this.collision=new Tl(180,180),this.player=new Cl(this.camera,this.inputState,this.collision,this.audio),this.player.setOnDeath(()=>this.onPlayerDeath()),this.collision.clear(),this.city=new ql(this.scene,this.collision,this.env),this.lighting=new Ql(this.scene,this.city,this.renderer,this.quality),this.sky=new $l(this.scene),this.postfx=new Id(this.scene,this.camera,this.renderer,{strength:.25}),this.audio=new Sd,this.player&&(this.player.audio=this.audio),this.input&&this.input.on(`mute`,()=>this.audio.toggleMuted()),this.weapon=new Eu(this.scene,this.camera,this.collision,this.audio),this.weapon.getZombies=()=>this.zombies,this.weapon.inputState=this.inputState,this.drops=new ku(this.scene,this.audio),this.flashlight=new Ru(this.camera,this.audio),this.waveManager=new gd(this.scene,this.city.getSpawnPoints(),this.collision,this.audio,{onWaveStart:e=>{this.screens&&this.screens.showBanner(`WAVE `+e)},onWaveCleared:e=>{this.screens&&this.screens.showBanner(`WAVE `+e+` CLEARED`),this.audio&&this.audio.playWaveCleared?.(e)},spawnZombie:(e,t,n)=>this.spawnZombie(e,t,n)}),this.score=new Hu(this.env,()=>this.waveManager?this.waveManager.wave:1),this.blood=new Yu(this.scene),this.weapon&&(this.weapon.shotgun.blood=this.blood,this.weapon.axe.blood=this.blood),this.env.document&&(this.hud=new _d(this.env.document.getElementById(`hud-root`),this.env.document.getElementById(`fx-root`)),this.screens=new vd(this.env.document.getElementById(`screens-root`),this),this.flashlight&&(this.hud.flashlight=this.flashlight),this.score&&(this.hud.score=this.score)),this.weapon&&(this.weapon.onHit=()=>{this.hud&&this.hud.hitMarker()}),this.player&&(this.player._onDamaged=(e,t)=>{this.hud&&this.hud.dmgFeedback(e,t)})}setState(e){if(this.state===e)return;let t=this.state;this.state=e,console.debug(`state`,t,`->`,e),e===Ld.PAUSED&&this.input&&this.input.locked()&&this.env.document&&this.env.document.exitPointerLock()}startGame(){if(this.state!==Ld.PLAYING){this.player&&this.player.reset(),this.weapon&&this.weapon.reset();for(let e of this.zombies)e.dispose();this.zombies=[],this.kills=0,this.drops&&this.drops.clear(),this.flashlight&&this.flashlight.reset(),this.score&&this.score.reset(),this.blood&&this.blood.clear(),this.hud&&this.hud.clearMarker(),this.timeInGame=0,this.waveManager&&this.waveManager.reset(),this.setState(Ld.PLAYING),this.input&&!this.input.locked()&&this.input.requestLock(),this.audio&&(this.audio.startAmbient(),this.audio.playStart?.()),this.screens&&this.screens.showGameplay()}}togglePause(){this.state===Ld.PLAYING?this.setState(Ld.PAUSED):this.state===Ld.PAUSED&&(this.input&&!this.input.locked()?this.input.requestLock():this.setState(Ld.PLAYING))}handleUnlock(){this.state===Ld.PLAYING&&this.setState(Ld.PAUSED)}onPlayerDeath(){this.setState(Ld.GAMEOVER),this.input&&this.input.locked()&&this.env.document&&this.env.document.exitPointerLock(),this.audio&&this.audio.stopAmbient();let e=this.score?this.score.newRecord():!1;this.screens&&this.screens.showGameOver({wave:this.waveManager?this.waveManager.wave:0,kills:this.kills,score:this.score?this.score.value:0,best:this.score?this.score.best:0,record:e})}update(e){this.player&&!this.player.isDead&&this.player.update(e),this.weapon&&this.weapon.update(e,this.player),this.blood&&this.blood.update(e),this.flashlight&&this.flashlight.update(e,this.inputState);for(let t of this.zombies)t.update(e,this.player,this.zombies,this.collision,this.audio);for(let e=this.zombies.length-1;e>=0;e--){let t=this.zombies[e];t.isDead&&!t._killCounted&&(t._killCounted=!0,this.kills++,this.hud&&this.hud.killMarker(),this.score&&this.score.addKill(t.type,this.waveManager?this.waveManager.wave:1),this.drops&&this.drops.maybeSpawn(t.position.x,t.position.z)&&this.audio?.drop?.()),t.deadAndGone?(this.zombies.splice(e,1),t.dispose()):t.isDead&&t.deathTimer>=5&&(t.deadAndGone=!0)}this.audio&&this.audio.updateGroans(e,this.zombies,this.player?this.player.position:this.camera.position,this.player?this.player.yaw:0),this.drops&&this.drops.update(e,this.player,()=>{this.weapon&&(this.weapon.shotgun.reserve+=8),this.audio&&this.audio.pickup?.()}),this.waveManager&&this.waveManager.update(e,this),this.lighting&&this.lighting.update(this.player?this.player.position:this.camera.position),this.sky&&this.sky.update(this.player?this.player.position:this.camera.position),this.city&&this.city.update(this.player?this.player.position:this.camera.position,e)}spawnZombie(e,t,n){let r=this.waveManager?this.waveManager.wave:1,i=new pd(this.scene,e,t,n,r);return this.zombies.push(i),i}render(){this.renderer&&this.scene&&(this.postfx&&this.postfx.enabled?this.postfx.render():this.renderer.render(this.scene,this.camera))}rendererStats(){return{fps:this._fps,calls:this.renderer?this.renderer.info.render.calls:0,tris:this.renderer?this.renderer.info.render.triangles:0}}sceneStats(){let e=0,t=0,n=0,r=0;return this.scene&&this.scene.traverse(i=>{i.isMesh||i.isSprite?e++:i.isPoints?t++:i.isLight?n++:(i.isGroup||i.isObject3D&&i.children.length)&&r++}),{meshes:e,points:t,lights:n,groups:r,zombies:this.zombies.length}}};function Bd(){let e=()=>{},t={width:256,height:256,style:{}};return t.getContext=t=>t===`2d`?new Proxy({},{get:(t,n)=>typeof n==`string`?e:void 0}):null,t}var Vd=new zd({canvas:document.getElementById(`game-canvas`)});window.__game=Vd,Vd.start();